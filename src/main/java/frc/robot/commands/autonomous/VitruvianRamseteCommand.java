...
public class VitruvianRamseteCommand extends RamseteCommand {
    ...
    public void execute() {
        super.execute();
        SmartDashboardTab.putNumber("DriveTrain", "Velocity", Units.metersToFeet(m_driveTrain.getDriveTrainKinematics().toChassisSpeeds(m_driveTrain.getSpeedsMetersPerSecond()).vxMetersPerSecond));
    }
